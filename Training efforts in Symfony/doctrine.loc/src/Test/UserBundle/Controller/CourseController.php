...
use Test\UserBundle\Entity\Course;
use Test\UserBundle\Form\CourseType;
...
class CourseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestUserBundle:Course')->findAll();
     ...
     * @Method("POST")
     * @Template("TestUserBundle:Course:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestUserBundle:Course')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestUserBundle:Course:edit.html.twig")
     */
