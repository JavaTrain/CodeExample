...
use Test\UserBundle\Entity\Group;
use Test\UserBundle\Form\GroupType;
...
class GroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestUserBundle:Group')->findAll();
     ...
     * @Method("POST")
     * @Template("TestUserBundle:Group:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestUserBundle:Group')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestUserBundle:Group:edit.html.twig")
     */
